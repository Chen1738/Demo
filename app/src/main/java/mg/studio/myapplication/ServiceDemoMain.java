...
public class ServiceDemoMain extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.servicedemo_main);
    ...
    public void btnSend(View view) {
        ...
        intent.setAction(MydemoService.ACTION_MSG_TO_SERVICE);
        intent.putExtra(MydemoService.KEY_MSG_TO_SERVICE, msgToService);
    ...
    protected void onStart() {
        ...
        intentFilter.addAction(MydemoService.ACTION_UPDATE_CNT);
        intentFilter.addAction(MydemoService.ACTION_UPDATE_MSG);
        intentFilter.addAction(MydemoService.ACTION_UPDATE_USER_SERVICE_DEAD);
    ...
    private void startService() {
        ...
        myIntent = new Intent(this, MydemoService.class);
    ...
    private class MyMainReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(MydemoService.ACTION_UPDATE_CNT)) {
                int int_from_service = intent.getIntExtra(MydemoService.KEY_INT_FROM_SERVICE, 0);
                textViewCntReceived.setText("Service running for \n " + String.valueOf(int_from_service) + "seconds");
            } else if (action.equals(MydemoService.ACTION_UPDATE_MSG)) {
                String string_from_service = intent.getStringExtra(MydemoService.KEY_STRING_FROM_SERVICE);
                textViewMsgReceived.setText(String.valueOf(string_from_service));
            } else if (action.equals(MydemoService.ACTION_UPDATE_USER_SERVICE_DEAD)) {
                String statusService = intent.getStringExtra(MydemoService.KEY_STRING_FROM_SERVICE_INFO);
