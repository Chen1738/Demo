...
public class LayoutMain extends ListActivity{
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (position) {
                    case 0:
                        ...
                        startActivity(new Intent(LayoutMain.this,LinearActivity.class));
                        break;
                    case 1:
                        //Start Activity RelativeLayout
                        startActivity(new Intent(LayoutMain.this,RelativeActivity.class));
                        break;
