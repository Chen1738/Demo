...
public class ListViewCAMain extends AppCompatActivity{
    /*
    1 - Create a specific design for the item list: it may contain two or more view to be populated
 */
    //The arrayList to populate the listView
    private ArrayList<ListViewCAStudent> studentsList = new ArrayList<ListViewCAStudent>();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.listview_customadapter_main);
         ...
         */
        ListViewCAStudentArray studentArrayAdapter =
                new ListViewCAStudentArray(
                        getBaseContext(), // Current context
                        R.layout.listview_customadapter_item_layout, // the layout for each item in the list
    ...
    private void generateDummyContent() {
        ...
        for (String element : nameDummy) {
            ...
            studentsList.add(new ListViewCAStudent(studentName, Integer.valueOf(studentId)));
